...
exports.FVSCHEDULE = function(principal, schedule) {
  ...
  schedule = utils.parseNumberArray(_.flatten(schedule));
...
<<<<<<< Updated upstream
  values = utils.numbers(_.flatten(values));
  if (values instanceof Error) {
    return values;
  }
=======
  values = utils.numbers(values);
>>>>>>> Stashed changes
...
exports.MIRR = function(values, finance_rate, reinvest_rate) {
  values = utils.parseNumberArray(_.flatten(values));
  if (values instanceof Error) {
    return values;
  }
...
exports.NPV = function(rate) {
  ...
  var args = utils.arrayValuesToNumbers(_.flatten(arguments));
...
exports.XIRR = function(values, dates, guess) {
  ...
  dates = utils.parseDateArray(_.flatten(dates));
