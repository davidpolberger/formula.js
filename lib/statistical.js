...
exports.AVERAGE = function () {
  var range = utils.parseNumbersFromArguments(arguments);
  if (range instanceof Error)
    return range;
  if (range.length === 0)
    return error.div0;
...
exports.AVERAGEA = function () {
  var range = parseNumbersForAverageA(arguments);
...
//    return range;
//  }
//  return range.length === 0 ? error.value : Math.max.apply(Math, range);
//};
...
//    return range;
//  }
//  return range.length === 0 ? error.value : Math.min.apply(Math, range);
//};
