...
exports.AVEDEV = function() {
  var range = utils.parseNumbers(_.flatten(arguments), true);
...
exports.AVERAGEIF = function(range, criteria, average_range) {
  ...
  average_range = utils.parseNumbers(_.flatten(average_range), true);
...
exports.CORREL = function(array1, array2) {
  array1 = utils.parseNumbers(_.flatten(array1), true);
  if (array1 instanceof Error) {
    return array1;
  }
  array2 = utils.parseNumbers(_.flatten(array2), true);
...
exports.FORECAST = function(x, data_y, data_x) {
  ...
  data_y = utils.parseNumbers(_.flatten(data_y), true);
  if (data_y instanceof Error) {
    return data_y;
  }
  data_x = utils.parseNumbers(_.flatten(data_x), true);
...
exports.FREQUENCY = function(data, bins) {
  data = utils.parseNumbers(_.flatten(data), true);
  if (data instanceof Error) {
    return data;
  }
  bins = utils.parseNumbers(_.flatten(bins), true);
...
exports.GEOMEAN = function() {
  var args = utils.parseNumbers(_.flatten(arguments), true);
...
exports.GROWTH = function(known_y, known_x, new_x, use_const) {
  ...
  known_y = utils.parseNumbers(known_y);
...
exports.INTERCEPT = function(known_y, known_x) {
  ...
  for (var i = 0; i < n; i++) {
    ...
    x = utils.parseNumber(known_x[i]);
    if (x instanceof Error || y instanceof Error) {
      continue;
    }
    parsed_known_y.push(y);
    parsed_known_x.push(x);
  }
...
exports.LARGE = function(range, k) {
  range = utils.parseNumbers(_.flatten(range), true);
  if (range instanceof Error) {
    return range;
  }
  k = utils.parseNumber(k);
...
exports.PERCENTILE.EXC = function(array, k) {
  array = utils.parseNumbers(_.flatten(array), true);
...
exports.PROB = function(range, probability, lower, upper) {
  ...
  probability = utils.parseNumbers(_.flatten(probability), true);
  if (probability instanceof Error) {
    return probability;
  }
