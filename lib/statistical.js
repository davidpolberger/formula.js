...
exports.AVERAGEIF = function(range, criteria, average_range) {
  ...
  average_range = utils.parseNumbers(_.flatten(average_range));
...
exports.CORREL = function(array1, array2) {
  array1 = utils.parseNumbers(_.flatten(array1));
  if (array1 instanceof Error) {
    return array1;
  }
  array2 = utils.parseNumbers(_.flatten(array2));
...
exports.FORECAST = function(x, data_y, data_x) {
  ...
  data_y = utils.parseNumbers(_.flatten(data_y));
  if (data_y instanceof Error) {
    return data_y;
  }
  data_x = utils.parseNumbers(_.flatten(data_x));
