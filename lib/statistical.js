...
exports.AVEDEV = function () {
  ...
  return jStat.sum(jStat(numbers).subtract(jStat.mean(numbers)).abs()[0]) / numbers.length;
};
...
exports.AVERAGEA = function () {
  var numbers = parseNumbersForAverageA(arguments);
  return exports.AVERAGE(numbers);
};

exports.AVERAGEIF = function(numbers, criteria, average_range) {
  average_range = average_range || numbers;
  numbers = _.flatten(numbers);
  var parsed = utils.parseNumbersX(numbers, _.flatten(average_range));
  ...
  for (var i = 0; i < numbers.length; i++) {
    if (evalExpr(numbers[i] + criteria)) {
...
exports.KURT = function () {
  ...
  var stdev = jStat.stdev(numbers, true);
  if (stdev === 0) {
    return error.div0;
  }
...
exports.LARGE = function(numbers, k) {
  numbers = utils.parseNumbers(_.flatten(numbers));
  if (numbers instanceof Error) {
    return numbers;
  }
  if (numbers.length === 0) {
...
/**
 * For literal values, MAXA acts the same as MAX.  They do act differently for references, but this
 * library does not support references.
 */
exports.MAXA = exports.MAX;
//exports.MAXA = function () {
//  var numbers = utils.parseNumbersA(_.flatten(arguments));
//  if (numbers instanceof Error) {
//    return numbers;
//  }
//  return numbers.length === 0 ? error.value : Math.max.apply(Math, numbers);
//};
...
/**
 * For literal values, MINA acts the same as MIN.  They do act differently for references, but this
 * library does not support references.
 */
...
//    return numbers;
//  }
//  return numbers.length === 0 ? error.value : Math.min.apply(Math, numbers);
//};
...
exports.MODE.SNGL = function () {
  ...
  var mult = exports.MODE.MULT(numbers);
...
exports.PROB = function(numbers, probability, lower, upper) {
  ...
  if (lower === upper) {
    return (numbers.indexOf(lower) >= 0) ? probability[numbers.indexOf(lower)] : 0;
  }
  ...
  for (var i = 0; i < n; i++) {
    if (sorted[i] >= lower && sorted[i] <= upper) {
      result += probability[numbers.indexOf(sorted[i])];
    }
  }
  return result;
};
...
exports.QUARTILE.EXC = function(numbers, quart) {
  numbers = utils.parseNumbers(_.flatten(numbers));
  if (numbers instanceof Error) {
    return numbers;
  }
  ...
  switch (quart) {
    case 1:
      return exports.PERCENTILE.EXC(numbers, 0.25);
    case 2:
      return exports.PERCENTILE.EXC(numbers, 0.5);
    case 3:
      return exports.PERCENTILE.EXC(numbers, 0.75);
    default:
      return error.num;
  }
};

exports.QUARTILE.INC = function(numbers, quart) {
  numbers = utils.parseNumbers(_.flatten(numbers));
  if (numbers instanceof Error) {
    return numbers;
  }
  ...
  switch (quart) {
    case 1:
      return exports.PERCENTILE.INC(numbers, 0.25);
    case 2:
      return exports.PERCENTILE.INC(numbers, 0.5);
    case 3:
      return exports.PERCENTILE.INC(numbers, 0.75);
    default:
      return error.num;
  }
};
...
exports.RANK.AVG = function(number, numbers, order) {
  number = utils.parseNumber(number);
  if (number instanceof Error) {
    return number;
  }
  ...
  return (count > 1) ? (2 * numbers.indexOf(number) + count + 1) / 2 : numbers.indexOf(number) + 1;
};

exports.RANK.EQ = function(number, numbers, order) {
  number = utils.parseNumber(number);
  if (number instanceof Error) {
    return number;
  }
...
exports.SKEW = function () {
  ...
  var sigma = 0;
  for (var i = 0; i < n; i++) {
    sigma += Math.pow(numbers[i] - mean, 3);
  }
  return n * sigma / ((n - 1) * (n - 2) * Math.pow(jStat.stdev(numbers, true), 3));
};
...
exports.SKEW.P = function () {
  ...
  var m3 = 0;
  for (var i = 0; i < n; i++) {
    m3 += Math.pow(numbers[i] - mean, 3);
    m2 += Math.pow(numbers[i] - mean, 2);
  }
  m3 = m3 / n;
  m2 = m2 / n;
...
exports.SMALL = function(numbers, k) {
  numbers = utils.parseNumbers(_.flatten(numbers));
  if (numbers instanceof Error) {
    return numbers;
  }
...
exports.TRIMMEAN = function(numbers, percent) {
  numbers = utils.parseNumbers(_.flatten(numbers));
  if (numbers instanceof Error) {
    return numbers;
  }
  ...
  var trim = mathTrig.FLOOR(numbers.length * percent, 2) / 2;
  return jStat.mean(_.initial(_.rest(numbers.sort(function(a, b) {
    return a - b;
  }), trim), trim));
};
...
exports.VAR.P = function () {
  ...
  var sigma = 0;
  var mean = exports.AVERAGE(numbers);
  for (var i = 0; i < numbers.length; i++) {
...
exports.VARA = function () {
  ...
  var sigma = 0;
  var mean = exports.AVERAGEA(numbers);
  for (var i = 0; i < numbers.length; i++) {
    sigma += Math.pow(numbers[i] - mean, 2);
  }
  return sigma / (numbers.length - 1);
