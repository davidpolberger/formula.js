...
exports.LCM = function() {
  ...
  var o = utils.parseNumbers(_.flatten(arguments), true);
...
exports.SUMIF = function(range, criteria, sum_range) {
  ...
  for (var i = 0; i < range.length; i++) {
    if (evalExpr(JSON.stringify(range[i]) + criteria)) {
      var n = utils.parseNumber(sum_range[i]);
      if (!(n instanceof Error)) {
        result += n;
      }
    }
...
exports.SUMIFS = function() {
  var args = utils.argsToArray(arguments);
  var range = utils.parseNumbers(_.flatten(args.shift()), true);
  if (range instanceof Error) {
    return range;
  }
  var criteria = args;
...
exports.SUMSQ = function() {
  var numbers = utils.parseNumbers(_.flatten(arguments), true);
...
exports.SUMX2MY2 = function(array_x, array_y) {
  array_x = utils.parseNumbers(_.flatten(array_x), true);
  if (array_x instanceof Error) {
    return array_x;
  }
  array_y = utils.parseNumbers(_.flatten(array_y), true);
...
exports.SUMX2PY2 = function(array_x, array_y) {
  ...
  var result = 0;
  array_x = utils.parseNumbers(_.flatten(array_x));
  array_y = utils.parseNumbers(_.flatten(array_y));
  for (var i = 0; i < array_x.length; i++) {
    result += array_x[i] * array_x[i] + array_y[i] * array_y[i];
  }
  return result;
